...
function About() {
    ...
    <ul>
        <li>⭐ <strong>Explorer at Heart:</strong> I love discovering new books, solving cool math puzzles,
            and building crazy science experiments!</li>
        <li>⭐ <strong>Sport Enthusiast:</strong> You'll often find me racing on the field, playing Cricket,
            or enjoying a good game with friends. 🏀⚽</li>
        <li>⭐ <strong>Little Artist:</strong> I enjoy sketching, doodling, and bringing my imagination to life with colors! 🎨🖌️</li>
    ...
    <p>I believe every school day is a new adventure—one step closer to discovering something amazing!
        Ready to explore more about me? Check out my <strong><a href={Gallery}>Gallery</a></strong>, peek at my <strong><a href={academicPerformance}>Academic Achievements</a></strong>,
